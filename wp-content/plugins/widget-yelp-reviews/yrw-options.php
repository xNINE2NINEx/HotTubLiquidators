...
<div class="form-group">
    <div class="col-sm-12">
        <label>
            <input id="<?php echo $this->get_field_id('read_on_yelp'); ?>" name="<?php echo $this->get_field_name('read_on_yelp'); ?>" type="checkbox" value="1" <?php checked('1', $read_on_yelp); ?> class="form-control" />
