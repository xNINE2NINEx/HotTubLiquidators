<?php 
/*template name: Spa Show Extended */
get_header( 'ss' ); ?>
<style>
	...
	<div class="row">
		<div class="container">
			<div class="row">
				...
				<h1 style="color:#000000; text-align: center; padding-bottom: 20px;"><strong>Show Extended thru 7pm&nbsp;Mon.,&nbsp;Nov.&nbsp;12!</strong></h1>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-9">
					...
					<h2 class="text-yellow"><strong>Now Through 7pm Mon. Nov. 12th</strong></h2>
				...
				<div class="col-lg-12">
					...
					<div class="video">
						...
						<video width="100%" height="auto" controls>
  							<source src="../wp-content/uploads/2018/11/video/HTL_November2018_15C.mp4" type="video/mp4">
  							<source src="../wp-content/uploads/2018/11/video/HTL_November2018_15C.mp4" type="video/ogg">
						</video>

					<h1>One Block North of I-215 &amp; Gibson RD Exit #2!</h1>
					<h2> (Between the 215 &amp; The Valley Auto Mall on Gibson RD) </h2>
					<h1 class="text-yellow">Show Ends 7pm Mon. Nov. 12th!</h1>
