...
// register accolades type
	register_post_type( 'accolades', 
		array(
			'labels' 	=> array(
			  'name' 	=> __( 'Accolades', 'hottub' ),
			  'singular_name' => __( 'Accolade Logos' ),
			  'all_items' => __( 'All Accolades' )
			),
			'show_ui' 			=> true,
			'public' 			=> true,
  ...
  function hottub_accolades_footer(){
  ...
  add_shortcode( 'accolades', 'hottub_accolades_footer' );
